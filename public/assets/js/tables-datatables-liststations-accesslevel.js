...
$(function () {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter = dt_filter_table.DataTable({
            ajax: assetsPath + "json/database/listStations.json",
            columns: [
                { data: "name" },
                { data: "Number_of_operators" },
                { data: "managername" },
                { data: "city" },
                { data: "status" },
                { data: "" },
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            '<a href="/accesslevel/accessroles" class="dropdown-item">نقش‌ها ومجوزها</a>' +
                            "</div>" +
                            "</div>" +
                            '<a href="/accesslevel/accessroles" class="btn btn-sm btn-icon item-edit"><i class="bx bxs-show"></i></a>'
                        );
                    },
                },
            ],
