            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12 mb-4 order-2 order-lg-0">
                    <div class="card h-100">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center me-3">
                                ...
                                <div class="card-title mb-0">
                                    <h5 class="mb-0">گزارش مغایرت در بارنامه گرمک میرجاوه (مبدا)</h5>
                                    <small class="text-muted primary-font">سید علی زمانی اپراتور اسکنر صاپا 1</small>
                                </div>
                            </div>
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center me-3">
                                <img src="../../assets/img/avatars/10.png" alt="آواتار" class="rounded-circle me-3"
                                    width="54">
                                <div class="card-title mb-0">
                                    <h5 class="mb-0">گزارش مغایرت در بارنامه ایستگاه تهران  (مقصد)</h5>
                    ...
                    <table class="dt-advanced-search table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th>رفتار سگ/ مبدا</th>
                                <th>رفتار سگ/ مقصد</th>
                                <th>مشاهدات کاربر/ مبدا </th>
                                <th>مشاهدات کاربر/ مقصد </th>
                                <th>نتیجه</th>
                                <th>توضیحات</th>
                                <th>نمایش جزئیات</th>
...
@section('scripts')
    ...
    <!-- Page JS -->
    <script src="../../assets/js/tables-datatables-compaire-origindestination.js"></script>
@endsection
