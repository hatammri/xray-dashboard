                            ...
                            <div class="col-12">
                                <div class="row g-3">
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        ...
                                        <input type="text" class="form-control dt-input dt-full-name" data-column="1" placeholder="BR2345" data-column-index="0">
                                      </div>
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        ...
                                        <select class="select2 form-select dt-input dt-name" data-column="2"
                                            data-column-index="0">
